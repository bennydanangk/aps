              ...
              <div class="card-body">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="dist/img/<img src="<?php echo base_url('assets/template/') ?>dist7-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="dist/img/<img src="<?php echo base_url('assets/template/') ?>dist3-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="dist/img/<img src="<?php echo base_url('assets/template/') ?>dist5-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="dist/img/<img src="<?php echo base_url('assets/template/') ?>dist6-128x128.jpg" alt="User Avatar">
